...
class ItemDescription extends StatelessWidget {
  ...
  ItemDescription({required this.title})
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: const ItemDescriptionUI(),
      ),
    );
  }
}

class ItemDescriptionUI extends StatefulWidget {
  const ItemDescriptionUI({Key? key}) : super(key: key);

  @override
  _ItemDescriptionUIState createState() => _ItemDescriptionUIState();
}

class _ItemDescriptionUIState extends State<ItemDescriptionUI> {
  ...
  var selecteditem = "Pizza";
  String dropdownvalue = 'Pizza';

  var items = ['Thali', 'Fast Food', 'Pizza', 'Burger', 'Dosa', 'Chinese'];
