...
import 'package:foodcano/canteen/BottomNavigation/HomePage.dart';


import 'package:foodcano/canteen/CanteenSignUpPage.dart';
...
class canteenlogin extends StatefulWidget {
  const canteenlogin({Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            TextButton(
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) => CanteenSignupPage()));
                              },
                              child: Text(
                                'Sign Up',
                                style: GoogleFonts.comicNeue(
